...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        default=["Test_datasets/TIF1.tif", "Test_datasets/TIF2.tif", "Test_datasets/TIF3.tif"],  # Default GeoTIFF files
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,  # Make not required
        default="Prithvi_100M_config.yaml",  # Default YAML file
    ...
    parser.add_argument(
        ...
        required=False,  # Make not required
        type=str,
        default="Prithvi_100M.pt",  # Default checkpoint file
    ...
    parser.add_argument(
        "--img_size",
        default=224,  # Default image size
        type=int,
    ...
    parser.add_argument(
        "--input_indices",
        default=None,  # Default indices for channels
        type=int,
        nargs="+",
