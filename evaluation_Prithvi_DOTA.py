...
if __name__ == '__main__':
    ############### Parameters Setting ####################
    TEST_IMAGES_PATH = f"Preprocessed Datasets Prithvi/DOTA/test/images"
    TEST_MASKS_PATH = f"Preprocessed Datasets Prithvi/DOTA/test/masks"
    NUM_CLASSES = 8
    EPOCHS = 20
    LEARNING_RATE = 0.0001
    SAVED_MODEL_PATH = f"FineTuned_Prithvi_models_DOTA/final_segmentation_model_{EPOCHS}epochs_{LEARNING_RATE}.pth"
